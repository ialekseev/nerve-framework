...
namespace NerveFramework.Core.Extensions
{
    ...
    public static class QueryableExtensions
    {
        ...
        /// <summary>
        /// Orders an <see cref="IQueryable{T}"/>
        /// </summary>
        /// <param name="queryable">The current <see cref="IQueryable{T}"/></param>
        /// <param name="expressions">What expressions should be ordered</param>
        /// <typeparam name="TEntity">The entity</typeparam>
        /// <returns>An ordered <see cref="IQueryable{T}"/></returns>
        /// <exception cref="NotSupportedException">If the ordering is not supported</exception>
